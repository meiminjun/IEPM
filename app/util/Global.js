...
//	domain : "http://10.36.64.164:90",
	...
	tipsMsg : {
		...
		"proBudgetLength" : {
			"zh-cn" : "项目预算长度不能超过14位.",
			"en-us" : "The project budget no more than 14 length."
		},
		/**
		 * 项目注册开始日期为空
		 */
		...
		"actualCostIsNumber" : {
			"zh-cn" : "实际花费必须为数字.",
			"en-us" : "Actual cost must be a number."
		},
		/**
		 * 月报填报实际花费为长度不超过16位
		 */
		"actualCostLength" : {
			"zh-cn" : "实际花费长度不能超过16位.",
			"en-us" : "Actual cost no more than 16 length."
		},
		/**
		 * 填报月份为空提示
		 */
