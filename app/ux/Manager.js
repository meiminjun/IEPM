Ext.define('iEPM.ux.Manager', {
    ...
    _language   : navigator.language? navigator.language.toLowerCase() : navigator.userLanguage.toLowerCase(),
    _loaded     : true,
    _loadingInd : true,
    _locale     : {},
    _locales    : [
        { abbr : 'zh-cn', text : '中文简体'  },
        { abbr : 'en-us', text : 'English' }
    ],
    _tpl        : '',
    _type       : 'script',
