 ...
 * @date 20131031
 */
Ext.define('iEPM.ux.override.plugin.PullRefresh', {
    override: 'Ext.plugin.PullRefresh',
    
    requires: [
	   'iEPM.ux.override.Component'
    ],
 	   ...
 	   pullTpl: [
           '<div class="x-list-pullrefresh">',
               ...
               '<div class="x-list-pullrefresh-wrap">',
                   ...
                   '<div class="x-list-pullrefresh-updated">{lastUpdatedText}&nbsp;{[iEPM.util.PubOperation.pullRefreshDataFormat()]}</div>',
               '</div>',
           '</div>'
       ].join('')
    },
   ...
   setLocale: function(locale) {
       ...
       if(pullRefreshText) {
           ...
           if(Ext.isString(pullRefreshText)) {
               me.setPullRefreshText(pullRefreshText);
           }
       }
       ...
       if(releaseRefreshText) {
           ...
           if(Ext.isString(releaseRefreshText)) {
               me.setReleaseRefreshText(releaseRefreshText);
           }
       }
   ...
   resetRefreshState: function() {
       ...
       if(me.updatedEl){
    	   me.updatedEl.setHtml(this.getLastUpdatedText() + '&nbsp;' + iEPM.util.PubOperation.pullRefreshDataFormat());
       }
   }
});